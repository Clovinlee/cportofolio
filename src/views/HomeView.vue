    ...
    <div class="col-12 col-sm-7 d-flex flex-column justify-content-center align-items-center"
      ...
      <div class="overflow-hidden w-75">
        ...
        <p ref="summarycontent" style="font-weight: 200; text-align: justify;" class="m-0">Enthusiastic
          <span style="color: var(--orange);"><b>developer</b></span> and undergraduate last
          semester <span style="color: var(--orange);"><b>student</b></span>
          from Institut Sains dan Teknologi Terpadu Surabaya, <span style="color: var(--orange);"><b>Indonesia</b></span>.
        </p>
